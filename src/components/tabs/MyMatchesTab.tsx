...
import { allCheckins, sessionUser, selectedDate, memberDetails, currentGroupId, showToast, coreMembers } from '../App';
          ...
          {schedule.map((match, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Invite button for forming games - hidden in selection mode */}
                {match.isForming && !inSelectionMode && (
