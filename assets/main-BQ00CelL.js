...
Just select your name and check in when you can play!`}function $i(t,r){const n=t.replace(/[\s\-\(\)]/g,""),o=navigator.userAgent||"";return/iPad|iPhone|iPod/.test(o)?`sms:${n}&body=${encodeURIComponent(r)}`:`sms:${n}?body=${encodeURIComponent(r)}`}function Ii(t,r,n){return`mailto:${t}?subject=${encodeURIComponent(r)}&body=${encodeURIComponent(n)}`}async function Mi(t){const r=Jn(t),n=G.value||"Tennis Group";try{await navigator.share({title:`Join ${n}`,text:r}),Be(),w("Shared successfully!","success")}catch(o){o.name!=="AbortError"&&(console.error("Share failed:",o),na(t))}}async function na(t){const r=Jn(t);try{await navigator.clipboard.writeText(r),Be(),w("Message copied! Paste in SMS or email.","success")}catch{const o=document.createElement("textarea");o.value=r,o.style.position="fixed",o.style.left="-9999px",document.body.appendChild(o),o.select(),document.execCommand("copy"),document.body.removeChild(o),Be(),w("Message copied! Paste in SMS or email.","success")}}function Be(){Gn.value=!1,Yn.value="",Kn.value="",qn.value=""}function Di(t,r,n){Yn.value=t,Kn.value=r||"",qn.value=n||"",Gn.value=!0}function Ei(){const t=Yn.value,r=Kn.value,n=qn.value,o=Jn(t),a=G.value||"Tennis Group",i=typeof navigator<"u"&&navigator.share!==void 0;return e(De,{isOpen:Gn.value,onClose:Be,title:"",showCloseButton:!1,children:e("div",{style:{textAlign:"center",padding:"10px 0"},children:[e("h3",{style:{margin:"0 0 12px 0",fontSize:"16px"},children:["Invite ",t,"?"]}),e("p",{style:{margin:"0 0 16px 0",color:"#666",fontSize:"14px"},children:"Send them an invite with the group link and PIN"}),e("div",{style:{display:"flex",gap:"10px",justifyContent:"center",flexWrap:"wrap"},children:[r&&e("a",{href:$i(r,o),onClick:()=>setTimeout(Be,500),style:{background:"#25D366",color:"white",padding:"12px 20px",border:"none",borderRadius:"8px",fontSize:"14px",cursor:"pointer",display:"inline-flex",alignItems:"center",gap:"8px",textDecoration:"none"},children:[e("span",{children:"📱"})," Text ",r]}),n&&e("a",{href:Ii(n,`You're invited to ${a}`,o),onClick:()=>setTimeout(Be,500),style:{background:"#4285F4",color:"white",padding:"12px 20px",border:"none",borderRadius:"8px",fontSize:"14px",cursor:"pointer",display:"inline-flex",alignItems:"center",gap:"8px",textDecoration:"none"},children:[e("span",{children:"📧"})," Email"]}),i&&e("button",{onClick:()=>Mi(t),style:{background:"#9C27B0",color:"white",padding:"12px 20px",border:"none",borderRadius:"8px",fontSize:"14px",cursor:"pointer",display:"inline-flex",alignItems:"center",gap:"8px"},children:[e("span",{children:"📤"})," Other"]}),e("button",{onClick:()=>na(t),style:{background:"#607D8B",color:"white",padding:"12px 20px",border:"none",borderRadius:"8px",fontSize:"14px",cursor:"pointer",display:"inline-flex",alignItems:"center",gap:"8px"},children:[e("span",{children:"📋"})," Copy"]})]}),e("button",{onClick:Be,style:{marginTop:"12px",background:"none",border:"none",color:"#999",fontSize:"14px",cursor:"pointer"},children:"Skip"})]})})}const oa=v(!1),ht=v(null),Br=v(""),Ut=v(""),Wt=v(""),Vt=v(""),Ae=v(""),jr=v(!1),Gt=v(""),Yt=v(""),Kt=v(""),qt=v("");async function Ai(){const t=Gt.value.trim();if(!t){w("Please enter member name","error");return}const r=Yt.value.trim(),n=Kt.value.trim();await Wn({name:t,phone:r,email:n,notes:qt.value.trim(),addedBy:k.value||"Admin"}),Gt.value="",Yt.value="",Kt.value="",qt.value="",jr.value=!1}function aa(){Gt.value="",Yt.value="",Kt.value="",qt.value="",jr.value=!1}function Ri(t){confirm(`Remove ${t} from the group?`)&&ea(t)}function Ti(t){ht.value=t,Br.value=t;const r=q.value[t]||{};Ut.value=r.phone||"",Wt.value=r.email||"",Vt.value=r.notes||""}async function Pi(){const t=ht.value;if(!t)return;const r=C.value;if(!r)return;const n=Br.value.trim();try{if(n!==t&&!await ta(t,n))return;const o=n!==t?n:t;await R().ref(`groups/${r}/settings/memberDetails/${o}`).update({phone:Ut.value,email:Wt.value,notes:Vt.value}),q.value={...q.value,[o]:{...q.value[o]||{},phone:Ut.value,email:Wt.value,notes:Vt.value}},ht.value=null,n===t&&w("Member updated","success")}catch(o){console.error("Error updating member:",o),w("Failed to update member","error")}}function Ni(){oa.value=!1,ht.value=null,Ae.value="",aa()}function Li(){const t=V.value,r=q.value,n=t.filter(o=>o.toLowerCase().includes(Ae.value.toLowerCase())).sort((o,a)=>o.localeCompare(a));return e(De,{isOpen:oa.value,onClose:Ni,title:"Manage Members",subtitle:`${t.length} members in group`,children:[ht.value&&e("div",{style:"position: fixed; inset: 0; background: rgba(0,0,0,0.5); display: flex; align-items: center; justify-content: center; z-index: 1001;",children:e("div",{style:"background: white; padding: 24px; border-radius: 12px; max-width: 400px; width: 90%;",children:[e("h3",{style:"margin-top: 0;",children:"Edit Member"}),e("div",{style:"margin-bottom: 12px;",children:[e("label",{style:"font-size: 12px; color: #666; display: block; margin-bottom: 4px;",children:"Name"}),e("input",{type:"text",placeholder:"Member name",value:Br.value,onInput:o=>{Br.value=o.target.value},style:"width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; box-sizing: border-box;"})]}),e("div",{style:"margin-bottom: 12px;",children:[e("label",{style:"font-size: 12px; color: #666; display: block; margin-bottom: 4px;",children:"Phone"}),e("input",{type:"tel",placeholder:"Phone number",value:Ut.value,onInput:o=>{Ut.value=o.target.value},style:"width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; box-sizing: border-box;"})]}),e("div",{style:"margin-bottom: 12px;",children:[e("label",{style:"font-size: 12px; color: #666; display: block; margin-bottom: 4px;",children:"Email"}),e("input",{type:"email",placeholder:"Email address",value:Wt.value,onInput:o=>{Wt.value=o.target.value},style:"width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; box-sizing: border-box;"})]}),e("div",{style:"margin-bottom: 16px;",children:[e("label",{style:"font-size: 12px; color: #666; display: block; margin-bottom: 4px;",children:"Notes"}),e("textarea",{placeholder:"Notes (skill level, etc.)",rows:2,value:Vt.value,onInput:o=>{Vt.value=o.target.value},style:"width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; resize: vertical; box-sizing: border-box;"})]}),e("div",{style:"display: flex; gap: 8px;",children:[e("button",{onClick:()=>{ht.value=null},style:"flex: 1; background: #ccc; color: #333;",children:"Cancel"}),e("button",{onClick:Pi,style:"flex: 1; background: var(--color-primary, #2C6E49); color: white;",children:"Save"})]})]})}),e("div",{style:"margin-bottom: 16px;",children:e("div",{style:"position: relative;",children:[e("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"#999",style:"position: absolute; left: 12px; top: 50%; transform: translateY(-50%);",children:e("path",{d:"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"})}),e("input",{type:"text",placeholder:"Search members...",value:Ae.value,onInput:o=>{Ae.value=o.target.value},style:"width: 100%; padding: 12px 12px 12px 40px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; box-sizing: border-box;"}),Ae.value&&e("button",{onClick:()=>{Ae.value=""},style:"position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; padding: 0;",children:e("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"#999",children:e("path",{d:"M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"})})})]})}),e("div",{style:"max-height: 400px; overflow-y: auto; margin-bottom: 16px;",children:n.length===0?e("div",{style:"text-align: center; padding: 20px; color: #888;",children:Ae.value?"No members found":"No members yet"}):n.map(o=>{const a=r[o],i=a&&(a.phone||a.email||a.addedBy),l=a&&(a.phone||a.email),s=a?.addedDate?new Date(a.addedDate).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):null;return e("div",{style:"flex-direction: column; align-items: flex-start; padding: 12px; background: #f9f9f9; border-radius: 8px; margin-bottom: 8px;",children:[e("div",{style:"display: flex; justify-content: space-between; width: 100%; align-items: center;",children:[e("span",{style:"font-weight: 500;",children:o}),e("div",{style:"display: flex; gap: 4px;",children:[e("button",{onClick:()=>Ti(o),style:{background:"rgba(76, 175, 80, 0.1)",color:"var(--color-primary, #2C6E49)",border:"none",borderRadius:"50%",width:"32px",height:"32px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:"0"},title:"Edit",children:e("svg",{viewBox:"0 0 24 24",width:"16",height:"16",fill:"currentColor",children:e("path",{d:"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"})})}),l&&e("button",{onClick:()=>Di(o,a?.phone,a?.email),style:{background:"rgba(33, 150, 243, 0.1)",color:"#2196F3",border:"none",borderRadius:"50%",width:"32px",height:"32px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:"0"},title:"Invite",children:e("svg",{viewBox:"0 0 24 24",width:"16",height:"16",fill:"currentColor",children:e("path",{d:"M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"})})}),e("button",{onClick:()=>Ri(o),style:{background:"rgba(255, 82, 82, 0.1)",color:"#e57373",border:"none",borderRadius:"50%",width:"32px",height:"32px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:"0"},title:"Remove",children:e("svg",{viewBox:"0 0 24 24",width:"16",height:"16",fill:"currentColor",children:e("path",{d:"M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"})})})]})]}),i&&e("div",{style:"font-size: 12px; color: #666; margin-top: 8px; padding-left: 12px; border-left: 3px solid var(--color-primary, #2C6E49);",children:[a?.addedBy&&e("div",{children:["Added by: ",e("strong",{children:a.addedBy}),s&&` on ${s}`]}),a?.phone&&e("div",{children:["📱 ",a.phone]}),a?.email&&e("div",{children:["📧 ",a.email]}),a?.notes&&e("div",{children:["Notes: ",a.notes]})]})]},o)})}),e("div",{style:"padding-top: 12px; border-top: 1px solid #e0e0e0;",children:jr.value?e("div",{style:"background: #f9f9f9; padding: 16px; border-radius: 8px;",children:[e("h4",{style:"margin: 0 0 12px 0; font-size: 14px; color: #333;",children:"Add New Member"}),e("input",{type:"text",placeholder:"Member's full name",value:Gt.value,onInput:o=>{Gt.value=o.target.value},style:"width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; margin-bottom: 8px; box-sizing: border-box;"}),e("div",{style:"display: flex; gap: 8px; margin-bottom: 8px;",children:[e("input",{type:"tel",placeholder:"Phone (optional)",value:Yt.value,onInput:o=>{Yt.value=o.target.value},style:"flex: 1; padding: 10px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; box-sizing: border-box;"}),e("input",{type:"email",placeholder:"Email (optional)",value:Kt.value,onInput:o=>{Kt.value=o.target.value},style:"flex: 1; padding: 10px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; box-sizing: border-box;"})]}),e("textarea",{placeholder:"Notes (skill level, how you know them, etc.) - optional",rows:2,value:qt.value,onInput:o=>{qt.value=o.target.value},style:"width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; resize: vertical; margin-bottom: 12px; box-sizing: border-box; font-family: inherit;"}),e("div",{style:"font-size: 12px; color: #666; margin-bottom: 12px;",children:["Added by: ",e("strong",{children:k.value||"Admin"})]}),e("div",{style:"display: flex; gap: 8px;",children:[e("button",{onClick:aa,style:"flex: 1; padding: 10px; background: #ccc; color: #333; border: none; border-radius: 8px; cursor: pointer; font-weight: 500;",children:"Cancel"}),e("button",{onClick:Ai,style:"flex: 2; padding: 10px; background: var(--color-primary, #2C6E49); color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 500;",children:"Add Member"})]})]}):e("button",{onClick:()=>{jr.value=!0},style:"width: 100%; padding: 12px; background: var(--color-primary, #2C6E49); color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 500; display: flex; align-items: center; justify-content: center; gap: 8px;",children:[e("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"currentColor",children:e("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"})}),"Add New Member"]})})]})}const Jt=v(!1),nn=v("");async function Fi(t,r){try{const n=R(),o=new Date().toISOString().split("T")[0];await n.ref(`groups/${t}/activity/${o}`).push({timestamp:Date.now(),action:"user_login",player:r,by:r})}catch(n){console.error("Error logging login activity:",n)}}function Bi(t){k.value=t;const r=C.value;r&&(localStorage.setItem(`sessionUser_${r}`,t),Fi(r,t)),Vr.value=t,Wr.value=!0,Jt.value=!1,window.scrollTo(0,0),w(`Welcome, ${t}!`,"success")}function ji(){const t=[...V.value].sort((a,i)=>a.localeCompare(i)),r=nn.value.toLowerCase(),n=r?t.filter(a=>a.toLowerCase().includes(r)):t,o=a=>{nn.value=a.target.value};return e(De,{isOpen:Jt.value,title:"",showCloseButton:!1,children:[e("div",{class:"welcome-modal-content",children:[e("div",{class:"welcome-header",children:[e("h2",{children:"Welcome Back"}),e("p",{class:"group-name",children:G.value})]}),e("p",{class:"instruction",children:"Select your name to start"}),e("div",{class:"search-container",children:e("input",{type:"text",placeholder:"Search member...",value:nn.value,onInput:o,class:"search-input"})}),e("div",{class:"member-list",children:[n.map(a=>e("button",{class:"member-row",onClick:()=>Bi(a),children:[e("div",{class:"member-avatar",children:a.charAt(0).toUpperCase()}),e("span",{class:"member-name",children:a})]},a)),n.length===0&&e("p",{class:"no-results",children:"No members found"})]})]}),e("style",{children:`
      ...
      `})]})}function Oi(t){if(t>3&&t<21)return"th";switch(t%10){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}}function Hi(t){return`https://wa.me/?text=${encodeURIComponent(t)}`}function Ui(t,r){const n=t.replace(/[\s\-\(\)]/g,""),o=encodeURIComponent(r),a=/iPhone|iPad|iPod/.test(navigator?.userAgent||"")?"&":"?";return`sms:${n}${a}body=${o}`}function ia(t){const r=new Date(t+"T12:00:00"),n=r.toLocaleDateString("en-US",{weekday:"long"}),o=r.toLocaleDateString("en-US",{month:"long"}),a=r.getDate(),i=Oi(a);return`${n}, ${o} ${a}${i}`}function Wi(t,r,n){const o=ia(r),a=[];a.push(`I'm checking in for tennis on ${o}!`),a.push("");const i=n.playStyle==="singles"?"Singles only":n.playStyle==="doubles"?"Doubles only":"Either singles or doubles";if(a.push(`Preference: ${i}`),n.timeRange){const l=ne(n.timeRange.start,n.timeRange.end);l&&a.push(`Available: ${l}`)}return a.join(`
`)}function Vi(t,r){return`I'm no longer available for tennis on ${ia(r)}.`}async function Gi(t){try{if(navigator.clipboard&&navigator.clipboard.writeText)return await navigator.clipboard.writeText(t),!0;const r=document.createElement("textarea");r.value=t,r.style.position="fixed",r.style.left="-999999px",r.style.top="-999999px",document.body.appendChild(r),r.focus(),r.select();const n=document.execCommand("copy");return document.body.removeChild(r),n}catch{return!1}}function Yi(t,r,n,o){return`Hi ${t}! You've been added to ${r} tennis coordination.
...
Just select your name and check in when you can play!`}const Xe=v(!1);typeof document<"u"&&document.addEventListener("click",t=>{const r=t.target;!r.closest(".share-prompt-dropdown")&&!r.closest("[data-share-prompt-button]")&&(Xe.value=!1)});function Ki(){const t=ge.value,r=ve.value;if(P(()=>{if(t){const h=setTimeout(()=>{ge.value=!1,ve.value=null},8e3);return()=>clearTimeout(h)}},[t]),!t||!r)return null;const n=r.action==="removal",o=r.action==="invite",a=()=>o?Yi(r.name,r.groupName||"",r.groupUrl||"",r.groupPin||""):n?Vi(r.name,r.date):Wi(r.name,r.date,{playStyle:r.playStyle||"both",timeRange:r.timeRange}),i=h=>{const u=a();if(h==="whatsapp"){const p=Hi(u);window.open(p,"_blank")}else if(h==="sms"){const p=Ui("",u);window.location.href=p}else h==="copy"&&Gi(u).then(p=>{p?w("Copied to clipboard","success"):w("Failed to copy","error")});Xe.value=!1,ge.value=!1,ve.value=null},l=()=>{ge.value=!1,ve.value=null},s=o?"var(--color-info-light, #E3F2FD)":n?"var(--color-warning-light, #FFF3E0)":"var(--color-success-light, #E8F5E9)",c=o?"var(--color-info, #1565C0)":n?"#E65100":"var(--color-success, #2E7D32)",d=o?"Added!":n?"Removed!":"Checked in!",g=o?`Invite ${r.name}?`:n?"Let others know?":"Share with the group?";return e("div",{style:{position:"fixed",bottom:"70px",left:"50%",transform:"translateX(-50%)",width:"calc(100% - 24px)",maxWidth:"456px",background:s,borderRadius:"12px",padding:"12px 16px",boxShadow:"var(--shadow-xl, 0 4px 12px rgba(0,0,0,0.15))",display:"flex",alignItems:"center",gap:"12px",zIndex:1e3,animation:"slideUp 0.3s ease-out"},children:[e("div",{style:{flex:1,fontSize:"14px",color:c},children:[e("strong",{children:d})," ",g]}),e("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[e("div",{style:{position:"relative"},children:[e("button",{"data-share-prompt-button":!0,onClick:h=>{h.stopPropagation(),Xe.value=!Xe.value},style:{background:Xe.value?"var(--color-primary-dark, #1a402b)":"var(--color-primary, #2C6E49)",color:"white",border:"none",borderRadius:"8px",padding:"8px 12px",fontSize:"13px",fontWeight:"500",cursor:"pointer",display:"flex",alignItems:"center",gap:"6px"},children:["Share",e("svg",{viewBox:"0 0 24 24",width:"14",height:"14",fill:"currentColor",children:e("path",{d:"M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 2.92-2.92-1.31-2.92-2.92-2.92z"})})]}),Xe.value&&e("div",{class:"share-prompt-dropdown",style:{position:"absolute",bottom:"100%",right:"0",marginBottom:"8px",background:"white",borderRadius:"12px",boxShadow:"var(--shadow-3xl, 0 4px 16px rgba(0,0,0,0.2))",zIndex:100,overflow:"hidden",minWidth:"140px"},children:[e("button",{onClick:()=>i("whatsapp"),style:{display:"flex",alignItems:"center",gap:"10px",padding:"12px 16px",width:"100%",border:"none",background:"white",cursor:"pointer",fontSize:"14px",color:"var(--color-text-primary, #333)"},children:[e("svg",{viewBox:"0 0 24 24",width:"20",height:"20",fill:"var(--color-whatsapp, #25D366)",children:e("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"})}),"WhatsApp"]}),e("button",{onClick:()=>i("sms"),style:{display:"flex",alignItems:"center",gap:"10px",padding:"12px 16px",width:"100%",border:"none",background:"white",cursor:"pointer",fontSize:"14px",color:"var(--color-text-primary, #333)"},children:[e("svg",{viewBox:"0 0 24 24",width:"20",height:"20",fill:"var(--color-info, #2196F3)",children:e("path",{d:"M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"})}),"SMS"]}),e("button",{onClick:()=>i("copy"),style:{display:"flex",alignItems:"center",gap:"10px",padding:"12px 16px",width:"100%",border:"none",background:"white",cursor:"pointer",fontSize:"14px",color:"var(--color-text-primary, #333)"},children:[e("svg",{viewBox:"0 0 24 24",width:"20",height:"20",fill:"#666",children:e("path",{d:"M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"})}),"Copy"]})]})]}),e("button",{onClick:l,style:{background:"transparent",border:"none",padding:"4px",cursor:"pointer",color:"#666",fontSize:"18px",lineHeight:1},title:"Dismiss",children:"×"})]}),e("style",{children:`
      ...
      `})]})}const $n=v(!1),tt=v(null),Pe=v(!1),Ne=v(-1);function qi(t){const r=E.value;if(!r)return null;const n=J.value[r]||[],o=n.findIndex(a=>a.name===t);return o===-1?null:{checkin:n[o],index:o}}function Ji(){const t=tt.value||k.value,r=!tt.value||tt.value===k.value,n=(s,c)=>{O.value=s,H.value=c},o=async()=>{if(!t){w("Please select a user first","error");return}const s=B.value,c=O.value&&H.value?{start:O.value,end:H.value}:void 0;Pe.value&&Ne.value>=0?await Qo(Ne.value,{playStyle:s,allowRotation:ke.value,timeRange:c},k.value||""):await _n({name:t,playStyle:s,isGuest:!1,addedBy:k.value,allowRotation:ke.value,timeRange:c}),ve.value={action:"checkin",name:t,playStyle:s,timeRange:c,date:E.value||""},ge.value=!0,i()},a=async()=>{Ne.value<0||(await Xo(Ne.value,k.value),ve.value={action:"removal",name:t||"",date:E.value||"",isOwner:r},ge.value=!0,i())},i=()=>{$n.value=!1,tt.value=null,Pe.value=!1,Ne.value=-1,B.value="both",ke.value=!0,O.value="",H.value=""},l=s=>{s.target.classList.contains("drawer-backdrop")&&i()};return $n.value?e("div",{class:"drawer-backdrop",onClick:l,children:[e("div",{class:"check-in-drawer",children:[e("div",{class:"drawer-handle",children:e("div",{class:"handle-bar"})}),e("div",{class:"drawer-header",children:[e("h2",{children:Pe.value?"Edit Check-in":"Check In"}),e("div",{class:"player-display",children:[e("div",{class:"player-avatar",children:t?.charAt(0).toUpperCase()}),e("div",{class:"player-info",children:[e("span",{class:"player-name",children:t}),e("span",{class:"player-context",children:r?"Playing as yourself":"Checking in for them"})]})]})]}),e("div",{class:"drawer-section",children:[e("h3",{children:"Play Style"}),e("div",{class:"preference-buttons",children:[e("button",{class:`pref-btn singles ${B.value==="singles"?"selected":""}`,onClick:()=>{B.value="singles"},children:"Singles"}),e("button",{class:`pref-btn ${B.value==="both"?"selected":""}`,onClick:()=>{B.value="both"},children:"Either"}),e("button",{class:`pref-btn doubles ${B.value==="doubles"?"selected":""}`,onClick:()=>{B.value="doubles"},children:"Doubles"})]})]}),e("div",{class:"drawer-section",children:e("label",{class:"rotation-toggle",children:[e("input",{type:"checkbox",checked:ke.value,onChange:s=>{ke.value=s.target.checked}}),e("span",{class:"toggle-label",children:[e("span",{class:"toggle-title",children:"Open to 3-player rotation"}),e("span",{class:"toggle-desc",children:"1v1 or 1v2 format when needed"})]})]})}),e("div",{class:"drawer-section",children:[e("h3",{children:["Available Time ",e("span",{class:"optional-tag",children:"optional"})]}),e("div",{class:"time-presets",children:[e("button",{class:`time-btn ${O.value==="08:00"&&H.value==="12:00"?"selected":""}`,onClick:()=>n("08:00","12:00"),children:[e("span",{class:"time-label",children:"Morning"}),e("span",{class:"time-range",children:"8am-12pm"})]}),e("button",{class:`time-btn ${O.value==="12:00"&&H.value==="15:00"?"selected":""}`,onClick:()=>n("12:00","15:00"),children:[e("span",{class:"time-label",children:"Midday"}),e("span",{class:"time-range",children:"12-3pm"})]}),e("button",{class:`time-btn ${O.value==="15:00"&&H.value==="18:00"?"selected":""}`,onClick:()=>n("15:00","18:00"),children:[e("span",{class:"time-label",children:"Afternoon"}),e("span",{class:"time-range",children:"3-6pm"})]}),e("button",{class:`time-btn ${O.value==="18:00"&&H.value==="21:00"?"selected":""}`,onClick:()=>n("18:00","21:00"),children:[e("span",{class:"time-label",children:"Evening"}),e("span",{class:"time-range",children:"6-9pm"})]})]}),e("div",{class:"custom-time",children:[e("input",{type:"time",value:O.value,onInput:s=>{O.value=s.target.value},placeholder:"Start"}),e("span",{class:"time-separator",children:"to"}),e("input",{type:"time",value:H.value,onInput:s=>{H.value=s.target.value},placeholder:"End"}),(O.value||H.value)&&e("button",{class:"clear-time-btn",onClick:()=>{O.value="",H.value=""},children:"Clear"})]})]}),e("div",{class:"drawer-actions",children:[e("button",{class:"cancel-btn",onClick:i,children:"Cancel"}),e("button",{class:"confirm-btn",onClick:o,children:Pe.value?"Update":"Confirm"})]}),Pe.value&&e("div",{class:"drawer-remove",children:e("button",{class:"remove-btn",onClick:a,children:"Remove Check-in"})})]}),e("style",{children:`
        .drawer-backdrop {
          position: fixed;
          top: 0;
          left: 0;
      ...
      `})]}):null}function Or(t,r){if(t?tt.value=t:tt.value=null,r&&t){Pe.value=!0;const n=qi(t);n&&(Ne.value=n.index,B.value=n.checkin.playStyle||"both",ke.value=n.checkin.allowRotation!==!1,n.checkin.timeRange&&(O.value=n.checkin.timeRange.start||"",H.value=n.checkin.timeRange.end||""))}else Pe.value=!1,Ne.value=-1,B.value="both",ke.value=!0,O.value="",H.value="";$n.value=!0}const In=v(!1),te=v("member"),wt=v("");function Qi(){te.value="member",wt.value="",Ze.value="",_t.value="",Ar.value="",Rr.value="",Tr.value="",fs.value=k.value||"",B.value="both",In.value=!0}function Xi(){const r=(()=>{const d=E.value,g=d?J.value[d]||[]:[],h=new Set(g.map(u=>u.name));return[...V.value].filter(u=>!h.has(u)).sort((u,p)=>u.localeCompare(p))})(),n=wt.value.toLowerCase(),o=n?r.filter(d=>d.toLowerCase().includes(n)):r,a=()=>{In.value=!1,wt.value=""},i=d=>{d.target.classList.contains("drawer-backdrop")&&a()},l=d=>{a(),Or(d,!1)},s=async()=>{if(!Ze.value.trim()){w("Please enter guest name","error");return}const d=B.value,g=O.value&&H.value?{start:O.value,end:H.value}:void 0;await _n({name:Ze.value.trim(),playStyle:d,isGuest:!0,addedBy:k.value,allowRotation:ke.value,timeRange:g}),ve.value={action:"checkin",name:Ze.value.trim(),playStyle:d,timeRange:g,date:E.value||""},ge.value=!0,a()},c=async()=>{if(!_t.value.trim()){w("Please enter member name","error");return}const d=_t.value.trim();await Wn({name:d,phone:Ar.value.trim(),email:Rr.value.trim(),notes:Tr.value.trim(),addedBy:k.value});const g=B.value,h=O.value&&H.value?{start:O.value,end:H.value}:void 0;await _n({name:d,playStyle:g,isGuest:!1,addedBy:k.value,allowRotation:ke.value,timeRange:h}),ve.value={action:"checkin",name:d,playStyle:g,timeRange:h,date:E.value||""},ge.value=!0,a()};return In.value?e("div",{class:"drawer-backdrop",onClick:i,children:[e("div",{class:"player-select-drawer",children:[e("div",{class:"drawer-handle",children:e("div",{class:"handle-bar"})}),e("div",{class:"drawer-header",children:[e("h2",{children:[te.value==="member"&&"Check in a player",te.value==="guest"&&"Add Guest",te.value==="newMember"&&"Add New Member"]}),e("div",{class:"mode-tabs",children:[e("button",{class:`mode-tab ${te.value==="member"?"active":""}`,onClick:()=>{te.value="member"},children:"Member"}),e("button",{class:`mode-tab ${te.value==="guest"?"active":""}`,onClick:()=>{te.value="guest"},children:"Guest"}),e("button",{class:`mode-tab ${te.value==="newMember"?"active":""}`,onClick:()=>{te.value="newMember"},children:"New Member"})]})]}),te.value==="member"&&e(A,{children:[e("div",{class:"search-container",children:e("input",{type:"text",placeholder:"Search member...",value:wt.value,onInput:d=>{wt.value=d.target.value},class:"search-input"})}),e("div",{class:"member-list",children:[o.map(d=>e("button",{class:"member-row",onClick:()=>l(d),children:[e("div",{class:"member-avatar",children:d.charAt(0).toUpperCase()}),e("span",{class:"member-name",children:d})]},d)),o.length===0&&e("p",{class:"no-results",children:r.length===0?"All members are already checked in":"No members found"})]})]}),te.value==="guest"&&e("div",{class:"form-section",children:[e("div",{class:"form-field",children:[e("label",{children:"Guest Name"}),e("input",{type:"text",placeholder:"Enter guest's name",value:Ze.value,onInput:d=>{Ze.value=d.target.value}})]}),e("div",{class:"form-field",children:[e("label",{children:"Play Style"}),e("div",{class:"preference-buttons",children:[e("button",{class:`pref-btn singles ${B.value==="singles"?"selected":""}`,onClick:()=>{B.value="singles"},children:"Singles"}),e("button",{class:`pref-btn ${B.value==="both"?"selected":""}`,onClick:()=>{B.value="both"},children:"Either"}),e("button",{class:`pref-btn doubles ${B.value==="doubles"?"selected":""}`,onClick:()=>{B.value="doubles"},children:"Doubles"})]})]}),e("div",{class:"drawer-actions",children:[e("button",{class:"cancel-btn",onClick:a,children:"Cancel"}),e("button",{class:"confirm-btn",onClick:s,children:"Add & Check In"})]})]}),te.value==="newMember"&&e("div",{class:"form-section",children:[e("div",{class:"form-field",children:[e("label",{children:"Full Name"}),e("input",{type:"text",placeholder:"Enter member's name",value:_t.value,onInput:d=>{_t.value=d.target.value}})]}),e("div",{class:"form-row",children:[e("div",{class:"form-field",children:[e("label",{children:["Phone ",e("span",{class:"optional",children:"(optional)"})]}),e("input",{type:"tel",placeholder:"Phone number",value:Ar.value,onInput:d=>{Ar.value=d.target.value}})]}),e("div",{class:"form-field",children:[e("label",{children:["Email ",e("span",{class:"optional",children:"(optional)"})]}),e("input",{type:"email",placeholder:"Email address",value:Rr.value,onInput:d=>{Rr.value=d.target.value}})]})]}),e("div",{class:"form-field",children:[e("label",{children:["Notes ",e("span",{class:"optional",children:"(optional)"})]}),e("textarea",{placeholder:"Skill level, how you know them, etc.",rows:3,value:Tr.value,onInput:d=>{Tr.value=d.target.value}})]}),e("p",{class:"added-by-info",children:["Added by: ",e("strong",{children:k.value||"(unknown)"})]}),e("div",{class:"drawer-actions",children:[e("button",{class:"cancel-btn",onClick:a,children:"Cancel"}),e("button",{class:"confirm-btn",onClick:c,children:"Add & Check In"})]})]})]}),e("style",{children:`
        .drawer-backdrop {
          position: fixed;
          top: 0;
          left: 0;
      ...
      `})]})}function sa(t){const r=q.value?.[t];$t.value=t,It.value=r?.phone||"",Mt.value=r?.email||"",Dt.value=r?.notes||"",Et.value=r?.shareContactInDirectory||!1,At.value=r?.shareNotesInDirectory||!1,rt.value=!1,Mr.value=t,Dn.value=!0}function ol(t){const r=k.value;return r?(J.value[t]||[]).some(o=>o.name&&_(o.name)===_(r)):!0}function al(t){E.value=t,k.value&&!ol(t)?(Vr.value=k.value,Wr.value=!0):(Vr.value="",Wr.value=!1)}function il(){const t=On(null);P(()=>{const a=t.current;if(!a)return;const i=setTimeout(()=>{const l=a.querySelector('[data-today="true"]');l&&l.scrollIntoView({behavior:"instant",inline:"start",block:"nearest"})},50);return()=>clearTimeout(i)},[]);const r=[],n=new Date,o=wn(n);for(let a=-14;a<=21;a++){const i=new Date(n);i.setDate(n.getDate()+a);const l=wn(i),s=i.toLocaleDateString("en-US",{weekday:"short"}),c=i.getDate(),d=i.toLocaleDateString("en-US",{month:"short"}),h=(J.value[l]||[]).length,u=l===o,p=a<0;r.push({value:l,dayName:s,dayNum:c,monthName:d,isToday:u,isPast:p,checkinCount:h})}return e("div",{class:"date-selector",children:e("div",{class:"date-scroll",ref:t,children:r.map(a=>e("button",{class:`date-btn ${E.value===a.value?"selected":""} ${a.isPast?"past":""}`,onClick:()=>al(a.value),"data-date":a.value,"data-today":a.isToday?"true":void 0,children:[e("span",{class:"day-name",children:a.dayName}),e("span",{class:"day-num",children:a.dayNum}),e("span",{class:"month-name",children:a.monthName}),a.isToday&&e("span",{class:"today-badge",children:"Today"}),a.checkinCount>0&&e("span",{class:"checkin-badge",children:a.checkinCount})]},a.value))})})}function ll(){const t=k.value,r=E.value;return!t||!r?null:(J.value[r]||[]).find(a=>a.name===t)||null}function sl(t){return t==="singles"?"Singles only":t==="doubles"?"Doubles only":"Either"}function cl(t){if(!t||!t.start||!t.end)return null;const r=n=>{const[o,a]=n.split(":"),i=parseInt(o),l=i>=12?"pm":"am",s=i>12?i-12:i===0?12:i;return a==="00"?`${s}${l}`:`${s}:${a}${l}`};return`${r(t.start)} - ${r(t.end)}`}function dl(){k.value;const t=ll(),r=!!t,n=()=>{Or()},o=()=>{Or(k.value,!0)},a=()=>{Qi()};return e(A,{children:[e("div",{class:"checkin-cta-section",children:[r?e("div",{class:"checkin-status-card",onClick:o,children:e("div",{class:"status-row",children:[e("span",{class:"status-icon",children:"✓"}),e("span",{class:"status-text",children:"You're in!"}),e("div",{class:"status-details",children:[e("span",{class:"detail-item",children:sl(t.playStyle)}),t.allowRotation!==!1&&e("span",{class:"detail-item rotation",children:"Open to 3s"}),t.timeRange&&e("span",{class:"detail-item time",children:cl(t.timeRange)})]}),e("button",{class:"edit-icon-btn",onClick:i=>{i.stopPropagation(),o()},title:"Edit",children:e("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"currentColor",children:e("path",{d:"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"})})})]})}):e("button",{class:"checkin-cta-btn",onClick:n,children:"Check In to Play"}),e("button",{class:"checkin-other-link",onClick:a,children:"Check in someone else"})]}),e("style",{children:`
        .checkin-cta-section {
          display: flex;
          flex-direction: column;
          align-items: center;
      ...
      `})]})}const kt=v({}),gr=v(null),on=v(!1);function ca(t){return{0:"☀️ Clear sky",1:"🌤️ Mainly clear",2:"⛅ Partly cloudy",3:"☁️ Overcast",45:"🌫️ Foggy",48:"🌫️ Foggy",51:"🌦️ Light drizzle",53:"🌦️ Drizzle",55:"🌧️ Heavy drizzle",61:"🌧️ Light rain",63:"🌧️ Rain",65:"🌧️ Heavy rain",71:"🌨️ Light snow",73:"🌨️ Snow",75:"🌨️ Heavy snow",77:"🌨️ Snow grains",80:"🌦️ Rain showers",81:"🌧️ Rain showers",82:"⛈️ Heavy rain showers",85:"🌨️ Snow showers",86:"🌨️ Heavy snow showers",95:"⛈️ Thunderstorm",96:"⛈️ Thunderstorm with hail",99:"⛈️ Severe thunderstorm"}[t]||"🌡️ Weather"}async function pl(t,r,n){const o=`${t},${r},${n}`;if(kt.value[o])return kt.value[o];try{const a=`https://api.open-meteo.com/v1/forecast?latitude=${t}&longitude=${r}&daily=temperature_2m_max,temperature_2m_min,precipitation_probability_max,weathercode&temperature_unit=fahrenheit&timezone=America/Los_Angeles&forecast_days=14`,i=await fetch(a);if(!i.ok)throw new Error("Weather API error");const l=await i.json();if(!l.daily||!l.daily.time||!Array.isArray(l.daily.time))throw new Error("Invalid weather data format");const s=l.daily.time.indexOf(n);if(s===-1)throw new Error("Weather data not available for this date");const c={tempMax:Math.round(l.daily.temperature_2m_max[s]),tempMin:Math.round(l.daily.temperature_2m_min[s]),precipProb:l.daily.precipitation_probability_max[s]||0,weatherCode:l.daily.weathercode[s]};return kt.value={...kt.value,[o]:c},c}catch(a){console.error("Weather fetch error:",a)}return null}function ul(){if(P(()=>{const n=ie(()=>{const o=E.value,a=I.value.location;if(!o)return;const i=new Date;i.setHours(0,0,0,0);const l=new Date(o+"T00:00:00"),s=Math.floor((l.getTime()-i.getTime())/(1e3*60*60*24));if(s<0||s>=14){gr.value=null;return}const c=a?.lat??37.2358,d=a?.lon??-121.9623;on.value=!0,pl(c,d,o).then(g=>{gr.value=g,on.value=!1})});return()=>n()},[]),on.value)return e("div",{id:"weatherWidget",style:{display:"flex",alignItems:"center",justifyContent:"center",padding:"10px 14px",background:"linear-gradient(135deg, #e3f2fd 0%, #f0f4ff 100%)",borderRadius:"10px",marginBottom:"8px",fontSize:"13px",boxShadow:"var(--shadow-md, 0 2px 8px rgba(0,0,0,0.05))",color:"#666"},children:"Loading weather..."});if(!gr.value)return null;const t=gr.value,r=I.value.location?.name||"Los Gatos, CA";return e("div",{id:"weatherWidget",style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 14px",background:"linear-gradient(135deg, #e3f2fd 0%, #f0f4ff 100%)",borderRadius:"10px",marginBottom:"8px",fontSize:"13px",boxShadow:"var(--shadow-md, 0 2px 8px rgba(0,0,0,0.05))"},children:[e("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[e("span",{style:{fontWeight:600,color:"#1976d2"},children:r}),e("span",{style:{color:"#666"},children:"•"}),e("span",{style:{color:"#666"},children:ca(t.weatherCode)})]}),e("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[e("span",{style:{fontWeight:600,color:"#333"},children:[t.tempMin,"°-",t.tempMax,"°F"]}),t.precipProb>0&&e("span",{style:{color:"#1976d2"},children:["💧",t.precipProb,"%"]})]})]})}function hl(){switch(I.value?.theme){case"roland-garros":return"#D2691E";case"australian-open":return"#1565C0";case"us-open":return"#0D47A1";case"wimbledon":default:return"#2E7D32"}}function gl(){switch(I.value?.theme){case"roland-garros":return"Roland-Garros";case"australian-open":return"Australian Open";case"us-open":return"US Open";case"wimbledon":return"Wimbledon";default:return"Classic"}}function vo({message:t="No check-ins yet",subtext:r="Be the first to check in!"}){const n=hl(),o="rgba(255, 255, 255, 0.9)";return e("div",{style:{textAlign:"center",padding:"var(--spacing-4xl, 24px) var(--spacing-2xl, 16px)",color:"var(--color-text-secondary, #666)"},children:[e("div",{style:{width:"120px",height:"80px",margin:"0 auto var(--spacing-2xl, 16px)",position:"relative",background:n,borderRadius:"var(--radius-lg, 8px)",overflow:"hidden",boxShadow:"var(--shadow-md, 0 2px 8px rgba(0,0,0,0.15))"},children:[e("div",{style:{position:"absolute",left:"50%",top:"20%",bottom:"20%",width:"2px",background:o,transform:"translateX(-50%)"}}),e("div",{style:{position:"absolute",left:"10%",right:"10%",top:"50%",height:"3px",background:o,transform:"translateY(-50%)",boxShadow:"0 1px 2px rgba(0,0,0,0.2)"}}),e("div",{style:{position:"absolute",left:"10%",right:"10%",top:"20%",height:"2px",background:o}}),e("div",{style:{position:"absolute",left:"10%",right:"10%",bottom:"20%",height:"2px",background:o}}),e("div",{style:{position:"absolute",left:"10%",top:"0",bottom:"0",width:"2px",background:o}}),e("div",{style:{position:"absolute",right:"10%",top:"0",bottom:"0",width:"2px",background:o}}),e("div",{style:{position:"absolute",left:"50%",top:"50%",transform:"translate(-50%, -50%)",width:"14px",height:"14px",borderRadius:"50%",background:"linear-gradient(135deg, #c8e600 0%, #9acd32 100%)",boxShadow:"0 2px 4px rgba(0,0,0,0.3), inset -2px -2px 4px rgba(0,0,0,0.1)",animation:"ballPulse 2s ease-in-out infinite"},children:e("div",{style:{position:"absolute",top:"3px",left:"2px",right:"2px",height:"8px",border:"1px solid rgba(255,255,255,0.5)",borderRadius:"50%",borderBottom:"none"}})})]}),e("p",{style:{fontSize:"var(--font-size-lg, 16px)",fontWeight:"600",color:"var(--color-text-primary, #333)",margin:"0 0 var(--spacing-sm, 6px) 0"},children:t}),e("p",{style:{fontSize:"var(--font-size-sm, 13px)",color:"var(--color-text-muted, #888)",margin:0},children:r})]})}function vl({text:t="Loading...",size:r="medium"}){const n={small:{ball:20,container:40},medium:{ball:32,container:60},large:{ball:48,container:90}},{ball:o,container:a}=n[r];return e("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"var(--spacing-4xl, 24px)"},children:[e("div",{style:{height:`${a}px`,display:"flex",alignItems:"flex-end",marginBottom:"var(--spacing-lg, 12px)"},children:e("div",{style:{width:`${o}px`,height:`${o}px`,borderRadius:"50%",background:"linear-gradient(135deg, #c8e600 0%, #9acd32 100%)",boxShadow:"0 4px 8px rgba(0,0,0,0.3), inset -3px -3px 6px rgba(0,0,0,0.1)",animation:"tennisBounce 0.6s ease-in-out infinite",position:"relative"},children:e("div",{style:{position:"absolute",top:`${o*.15}px`,left:`${o*.1}px`,right:`${o*.1}px`,height:`${o*.5}px`,border:`${Math.max(1,o*.06)}px solid rgba(255,255,255,0.6)`,borderRadius:"50%",borderBottom:"none"}})})}),e("div",{style:{width:`${o*.8}px`,height:`${o*.15}px`,background:"rgba(0,0,0,0.2)",borderRadius:"50%",marginTop:`-${o*.1}px`,animation:"ballShadow 0.6s ease-in-out infinite"}}),t&&e("p",{style:{fontSize:"var(--font-size-sm, 13px)",color:"var(--color-text-muted, #888)",marginTop:"var(--spacing-lg, 12px)"},children:t})]})}function fl({text:t="Loading..."}){const r=gl();return e("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"100vh",background:"var(--color-bg-page, #f5f5f5)"},children:[e(vl,{text:t,size:"large"}),r!=="Classic"&&e("p",{style:{fontSize:"var(--font-size-xs, 11px)",color:"var(--color-text-muted, #999)",marginTop:"var(--spacing-md, 8px)"},children:[r," theme"]})]})}const pe=v(localStorage.getItem("games_compact_view")!=="false"),da=v(!1),Qt=v(null),Re=v("both"),Hr=v(""),Ur=v(""),En=v(!0),pa=v(!1),An=v(null),$e=v(""),we=v(!1),Dr=v("confirm"),re=v(""),ua=v(""),Xt=v(null),je=v(!1),gt=v(!1),Z=v(null),ee=v(null);typeof document<"u"&&document.addEventListener("click",t=>{const r=t.target;!r.closest(".share-dropdown")&&!r.closest("[data-share-button]")&&(Xt.value&&(Xt.value=null),je.value&&(je.value=!1))});function Er(){pa.value=!1,An.value=null,$e.value="",we.value=!1,Dr.value="confirm",re.value="",ua.value=""}async function ml(){const t=An.value;if(t===null)return;const r=$e.value,n=we.value,o=re.value;An.value=null,await Xo(t,k.value),Er(),ve.value={action:"removal",name:r,date:o,isOwner:n},ge.value=!0}function ha(){da.value=!1,Qt.value=null}async function xl(){if(Qt.value===null)return;const t={playStyle:Re.value,allowRotation:En.value};(Hr.value||Ur.value)&&(t.timeRange={start:Hr.value,end:Ur.value}),await Qo(Qt.value,t,k.value),ha()}function bl(t){const r=C.value,n=t.name||"",o=k.value&&_(k.value)===_(n),a=t.addedBy&&k.value&&_(k.value)===_(t.addedBy),i=r&&sessionStorage.getItem(`adminAuth_${r}`)==="true";return!!(o||a||i)}function Ve({matchKey:t}){const r=W.value[t]||"",[n,o]=Me(r);return P(()=>{o(W.value[t]||"")},[W.value[t]]),e("div",{style:"padding: 8px 12px; background: var(--color-bg-muted, #f9f9f9); border-radius: var(--radius-lg, 8px); margin-top: 8px;",children:[e("div",{style:"font-size: 11px; color: var(--color-gray-base, #666); margin-bottom: 4px; font-weight: 500;",children:"Booking Details"}),e("input",{type:"text",placeholder:"e.g. Courtside Court 1, 12PM",value:n,onInput:i=>{o(i.target.value)},onBlur:()=>{const i=n.trim(),l=W.value[t]||"";i!==l&&qa(t,i)},style:{width:"100%",padding:"8px 12px",border:"1px solid var(--color-border, #e0e0e0)",borderRadius:"6px",fontSize:"14px",background:"white"}})]})}function Ge({players:t,checkins:r}){const n=k.value?_(k.value):"";return e("div",{style:"padding: 4px 0;",children:t.map(o=>{const a=n&&_(o.name)===n,i=r.findIndex(s=>_(s.name)===_(o.name)&&s.timestamp===o.timestamp),l=o.timeRange?ne(o.timeRange.start,o.timeRange.end):"";return e("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"6px 12px",borderBottom:"1px solid var(--color-border-light, #f0f0f0)",fontSize:"14px",background:a?"var(--color-primary-light, #E8F5E9)":"transparent"},children:[e("span",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[e("span",{style:{color:"var(--color-text-muted, #999)",fontSize:"13px",minWidth:"20px"},children:i>=0?`${i+1}.`:""}),e("span",{style:a?{fontWeight:600,color:"var(--color-primary, #2C6E49)"}:{},children:o.name}),a&&e("span",{style:{fontSize:"10px",background:"var(--color-primary, #2C6E49)",color:"white",padding:"1px 4px",borderRadius:"4px"},children:"YOU"}),l&&e("span",{style:{fontSize:"12px",color:"var(--color-text-muted, #999)",marginLeft:"4px"},children:l})]}),e("span",{style:{fontSize:"11px",padding:"2px 6px",borderRadius:"4px",background:o.playStyle==="singles"?"var(--color-blue-light, #E3F2FD)":o.playStyle==="doubles"?"var(--color-orange-light, #FFF3E0)":"var(--color-primary-light, #E8F5E9)",color:o.playStyle==="singles"?"var(--color-blue-base, #1976D2)":o.playStyle==="doubles"?"var(--color-orange-base, #F57C00)":"var(--color-primary, #2C6E49)",fontWeight:500},children:Jr(o.playStyle||"both")})]},o.name)})})}function yl(){const t=!pe.value;pe.value=t,localStorage.setItem("games_compact_view",String(t))}function Ce({checkin:t,globalIndex:r}){const n=k.value&&_(t.name)===_(k.value),o=bl(t);let a="";t.isGuest?a=`guest of ${t.addedBy}`:t.addedBy&&_(t.addedBy)!==_(t.name)&&(a=`added by ${t.addedBy}`);const i=t.timeRange?ne(t.timeRange.start,t.timeRange.end):"",l=()=>{Or(t.name,!0)};return e("div",{class:n?"checkin-item current-user":"checkin-item",children:[e("span",{children:[e("span",{class:"checkin-name",children:[r+1,". ",t.name,n&&e("span",{class:"current-user-badge",children:"YOU"}),a&&e("span",{class:"guest-indicator",children:[" ",a]}),i&&e("span",{class:"time-badge",children:i}),t.allowRotation===!1&&e("span",{class:"time-badge",style:"background: var(--color-orange-light, #fff3e0); color: var(--color-orange-dark, #e65100);",children:"No 3s"})]}),e("span",{class:`preference-badge ${t.playStyle||"both"}`,children:Jr(t.playStyle||"both")}),e("span",{class:"checkin-time",children:Un(t.timestamp)})]}),o&&e("button",{class:"edit-btn",onClick:l,title:"Edit check-in",style:{background:"white",color:"var(--color-primary, #2C6E49)",border:"1px solid var(--color-border, #e0e0e0)",borderRadius:"8px",padding:"0",width:"32px",height:"32px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all 0.2s"},children:e("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"currentColor",children:e("path",{d:"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"})})})]})}function wl(t,r){const o=new Date(r+"T00:00:00").toLocaleDateString("en-US",{weekday:"long",month:"short",day:"numeric"}),a=t.players.map(s=>s.name).join(" & "),i=C.value,l=`${window.location.origin}${window.location.pathname}#${i}`;if(t.type==="doubles-forming"){const s=t.needed||4-t.players.length;let d=`🎾 ${s===1?"1 more player needed":`${s} more players needed`} for doubles!
`;return d+=`📅 ${o}
...
Can you make it? ${i}`,s}return""}function cn(t,r){const n=Fl(t);if(r==="whatsapp"){const o=encodeURIComponent(n);window.open(`https://wa.me/?text=${o}`,"_blank")}else if(r==="sms"){const o=encodeURIComponent(n);window.open(`sms:?body=${o}`,"_blank")}else r==="copy"&&navigator.clipboard.writeText(n).then(()=>{w("Message copied!","success")}).catch(()=>{w("Failed to copy","error")});Zt.value=null}function xo(t){er.value||(E.value=t,oe.value="checkin")}function Bl(t){const r=`${t.type.replace("-forming","")}-${t.matchNumber}`,n=W.value[r]||"",o=Pl({date:t.date,matchType:t.type,players:t.players,groupName:G.value||"Tennis",location:I.value.location?.name,notes:n});Tl(o),w("Calendar event downloaded","success")}function jl(t){const r=new Set(He.value);r.has(t)?r.delete(t):r.add(t),He.value=r}function dn(){er.value=!1,He.value=new Set,Rt.value=!1}function Ol(t,r){const n=C.value,o=`${window.location.origin}${window.location.pathname}#${n}`,a=t.filter((c,d)=>{const g=`mygames-${c.date}-${c.type}-${d}`;return r.has(g)});if(a.length===0)return"";const i=a.filter(c=>!c.isForming),l=a.filter(c=>c.isForming);let s=`🎾 Tennis Update
